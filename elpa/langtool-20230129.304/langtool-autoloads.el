...
;;;***

;;;### (autoloads nil "langtool-popup" "langtool-popup.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from langtool-popup.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "langtool-popup" '("langtool-popup-")))
